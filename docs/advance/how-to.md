...
By default, PySME keeps the historical continuum-source treatment. To include
coherent continuum scattering in the continuum source function, enable the
opt-in switch before synthesis:
